...
import pylint.lint
from pylint.checkers import base, classes, variables
...
def check_valid_func_names_v2(user_file_name: str) -> int:
    """Функция проверяет соответствие названий функций, классов и функицй классов
    так же подклассов"""
    check_error = 0
    ...
    print(pylint_runner.linter.msg_status)
...
if __name__ == "__main__":
    ...
    result = check_valid_func_names_v2(file_name)
